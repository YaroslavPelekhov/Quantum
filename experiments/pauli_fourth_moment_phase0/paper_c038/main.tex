...
problem is exact on every line graph. For every finite simple graph $R$ and
every nonnegative edge weight $w$,
\[
...
priority. The expanded C045 search was frozen on 16 September 2026 and found
no exact collision, but this remains support rather than certification.
...
reported numerical constant is read from eight frozen JSON records by the
